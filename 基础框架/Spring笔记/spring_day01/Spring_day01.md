...
![Snipaste_2023-02-20_17-05-34](C:\Users\hp\Desktop\Snipaste_2023-02-20_17-05-34.png)
...
* 综上所述，对应关系如下:
* ![image-20230220165447852](C:\Users\hp\AppData\Roaming\Typora\typora-user-images\image-20230220165447852.png)
...
![image-20230220190352893](C:\Users\hp\AppData\Roaming\Typora\typora-user-images\image-20230220190352893.png)
...
* bean在容器中是单例的，会不会产生线程安全问题?
  ...
  * **因为所有请求线程共用一个bean对象，所以会存在线程安全问题。(设置值可能会出现问题，获取值就不会出现问题)**
...
**(1)创建一个UserDaoFactoryBean的类，实现FactoryBean<T（要返回的对象类型）>接口，重写接口的方法**
...
* ![image-20230221092218577](C:\Users\hp\AppData\Roaming\Typora\typora-user-images\image-20230221092218577.png)
...
**Spring提供了两个接口来完成生命周期的控制，好处是可以*不用*再进行配置`init-method`和`destroy-method`**
...
2. ![Snipaste_2023-02-20_17-05-34](C:\Users\hp\AppData\Roaming\Typora\typora-user-images\Snipaste_2023-02-20_17-05-34.png)
...
* ![image-20230221144613625](C:\Users\hp\AppData\Roaming\Typora\typora-user-images\image-20230221144613625.png)