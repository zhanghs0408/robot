...
![image-20230305145707196](C:\Users\hp\AppData\Roaming\Typora\typora-user-images\image-20230305145707196.png)
...
class Mybatisplus02DqlApplicationTests {
    ...
    @Test
    void testGetAll(){
        QueryWrapper<User> lqw = new QueryWrapper<User>();//只能用这个
...
为了在做结果封装的时候能够更简单，我们将上面的聚合函数都起了个名称，方面后期来获取这些数据,使用map集合来封装结果
