...
![image-20230303094519056](C:\Users\hp\AppData\Roaming\Typora\typora-user-images\image-20230303094519056.png)
...
![image-20230303102806743](C:\Users\hp\AppData\Roaming\Typora\typora-user-images\image-20230303102806743.png)
...
>
> * 所有的优先级指的是高优先级文件中的同名属性会优先加载，覆盖低优先级文件中的同名属性，但是所有文件都会被加载。
>
...
![image-20230303113526901](C:\Users\hp\AppData\Roaming\Typora\typora-user-images\image-20230303113526901.png)
...
这个警告提示解决是在 `pom.xml` 中添加如下依赖即可，可以对自定义的属性进行提示。
...
![image-20230303150913502](C:\Users\hp\AppData\Roaming\Typora\typora-user-images\image-20230303150913502.png)

![image-20230303151626385](C:\Users\hp\AppData\Roaming\Typora\typora-user-images\image-20230303151626385.png)
...
* 3级：file ：application.yml
  ...
  执行java-jar命令所在的目录，jar包的命令所在的目录
...
lombok的使用，勾选lombok的复选框，或者配置坐标直接使用其注解

![image-20230305102144984](C:\Users\hp\AppData\Roaming\Typora\typora-user-images\image-20230305102144984.png)
...
![image-20230303171507867](C:\Users\hp\AppData\Roaming\Typora\typora-user-images\image-20230303171507867.png)
...
导入`springboot`整合`pagehelper`的起步依赖
...
在`application.yml`文件中对`pagehelper`进行配置
...
## 6，springboot整合其它技术的套路

第一步：导入起步依赖

第二步(可选)：在yml文件中编写某些配置

第三步(可选)：javaconfig(编写某些配置类)